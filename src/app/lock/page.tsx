...
//           className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-linear-to-tr from-rose-100 to-rose-50 shadow-inner ring-1 ring-rose-200/50">
//           {isSuccess ? (
//             // Unlocked Icon
...
import { Cormorant_Garamond, Albert_Sans } from "next/font/google";
import LockClient from "./LockClient"; // Client Component ကို လှမ်းခေါ်ပါမည်
...
export default function LockPage() {
  return (
    ...
    >
      ...
      {/* === ၂။ Interactive Lock Component (Client Rendered) === */}
      {/* Font class များကို Props အနေဖြင့် ပေးပို့ပါမည် */}
      <LockClient titleFont={cormorant.className} />
    </main>
  );
}