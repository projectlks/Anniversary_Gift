...
export default function ClickCount() {
    ...
    return (
        <div className="flex flex-col items-center justify-center relative overflow-hidden p-4 sm:p-6">
            ...
            {/* Floating Animated Hearts (Pure CSS) */}
            ...
            <div
                onClick={() => { handleClick() }}
                className="aspect-[1/1] h-[100px] cursor-pointer flex items-center justify-center p-4 sm:p-6 bg-gradient-to-br from-rose-400 via-pink-500 to-pink-800 text-white shadow-2xl border border-white/30 hover:shadow-pink-500/50 hover:scale-105 transition-all duration-500 backdrop-blur-md relative z-10"
